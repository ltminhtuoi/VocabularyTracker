        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FlashcardSets_Users_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CorrectMeaning = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PracticeSessions_FlashcardSets_FlashcardSetId",
                        column: x => x.FlashcardSetId,
                        principalTable: "FlashcardSets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentFlashcardSets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentFlashcardSets_FlashcardSets_FlashcardSetId",
                        column: x => x.FlashcardSetId,
                        principalTable: "FlashcardSets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentFlashcardSets_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnswerOptions_Flashcards_FlashcardId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FlashcardAttempts_Flashcards_FlashcardId",
                        column: x => x.FlashcardId,
                        principalTable: "Flashcards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FlashcardAttempts_PracticeSessions_PracticeSessionId",
                        column: x => x.PracticeSessionId,
                        principalTable: "PracticeSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlashcardAttempts_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnswerOptions_FlashcardId",
                table: "AnswerOptions",
                column: "FlashcardId");

            migrationBuilder.CreateIndex(
                name: "IX_FlashcardAttempts_FlashcardId",
                table: "FlashcardAttempts",
                column: "FlashcardId");

            migrationBuilder.CreateIndex(
                name: "IX_FlashcardAttempts_PracticeSessionId",
                table: "FlashcardAttempts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlashcardAttempts_StudentId",
                table: "FlashcardAttempts",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlashcardSets_TeacherId",
                table: "FlashcardSets",
                column: "TeacherId");

            migrationBuilder.CreateIndex(
                name: "IX_PracticeSessions_FlashcardSetId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentFlashcardSets_FlashcardSetId",
                table: "StudentFlashcardSets",
                column: "FlashcardSetId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentFlashcardSets_StudentId",
                table: "StudentFlashcardSets",
                column: "StudentId");
